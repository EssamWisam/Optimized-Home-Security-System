...
set fp_units            micro
set fp_top_partition    "logic_hw"         ; # INPUT REQUIRED: Top partition name
...
set fp_rows_xl_margin       2.0   ; # Distance from left boundary to start rows
set fp_rows_yb_margin       2.0    ; # Distance from bottom boundary to start rows
set fp_rows_xr_margin       2.0    ; # Distance from right boundary to stop rows
set fp_rows_yt_margin       2.0    ; # Distance from top boundary to stop rows
...
# PG ring settings
set pg_ring_layers              {metal5 metal6}          ; # Metal layers for the rings in order {Hlayer Vlayer}
...
set pg_stripe_hlayers	        {metal6}	    ; # Layers for horizontal stripes, e.g. {METAL6}
...
set fp_well_tap_cell              ""                 ; # Specify the lib_cell used for well tie, e.g. WELL_TAP_LIB_CELL
